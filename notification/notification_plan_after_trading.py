...
class NotificationPlanAfterTrading:
    ...
    def equity_bond_yield_strategy_estimation_notification(self):
        ...
        # 邮件发送所有估值信息
        try:
            email_notification.EmailNotification().send_customized_content(' 股债收益率', time_strategy_msg)
            # 日志记录
        ...
        # 微信推送所有估值信息
        try:
            wechat_notification.WechatNotification().push_to_all(' 股债收益率', time_strategy_msg)
            # 日志记录
