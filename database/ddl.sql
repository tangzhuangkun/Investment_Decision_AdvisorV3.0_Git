...
CREATE TABLE IF NOT EXISTS `stocks_main_estimation_indexes_historical_data`(
	...
	`pe_ttm` DECIMAL(20,16) COMMENT '滚动市盈率',
	`pe_ttm_nonrecurring` DECIMAL(20,16) COMMENT '扣非滚动市盈率',
	`pb` DECIMAL(20,16) COMMENT '市净率',
	`pb_wo_gw` DECIMAL(20,16) COMMENT '扣商誉市净率',
	`ps_ttm` DECIMAL(20,16) COMMENT '滚动市销率',
	`pcf_ttm` DECIMAL(20,16) COMMENT '滚动市现率',
	`ev_ebit_r` DECIMAL(20,16) COMMENT 'EV/EBIT企业价值倍数 ',
	`stock_yield` DECIMAL(22,18) COMMENT '股票收益率',
	`dividend_yield` DECIMAL(22,18) COMMENT '股息率',
	`share_price` DECIMAL(20,4) COMMENT '股价',
	`turnover` BIGINT COMMENT '成交量',
	`fc_rights` DECIMAL(8,2) COMMENT '前复权',
	`bc_rights` DECIMAL(8,2) COMMENT '后复权',
	`lxr_fc_rights` DECIMAL(8,2) COMMENT '理杏仁前复权',
	`shareholders` BIGINT COMMENT '股东人数',
	`market_capitalization` DECIMAL(20,4) COMMENT '市值',
	`circulation_market_capitalization` DECIMAL(20,4) COMMENT '流通市值',
	`free_circulation_market_capitalization` DECIMAL(20,4) COMMENT '自由流通市值',
	`free_circulation_market_capitalization_per_capita` DECIMAL(20,4) COMMENT '人均自由流通市值',
	`financing_balance` DECIMAL(20,4) COMMENT '融资余额',
	`securities_balances` DECIMAL(20,4) COMMENT '融券余额',
	`stock_connect_holding_amount` DECIMAL(20,4) COMMENT '陆股通持仓金额',
